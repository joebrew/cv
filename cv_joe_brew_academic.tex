...
\usepackage{Sweave}
\begin{document}
\input{cv_joe_brew_academic-concordance}
...
\scshape{Joe Brew}\\
\end{Huge}
% \includegraphics[height=2em]{orcid} 

joe@databrew.cc | joe@hyfe.ai \hfill \\
+34 666 66 80 86 \hfill  \\
...
\item Coordinateed an international team of engineers, health care workers, and researchers
...
\vspace{-2mm}
\begin{itemize}\itemsep0pt \parskip0pt \parsep0pt
\item Designed and created researcher tools for large-scale surveys carried out by the World Bank Trade & Competitiveness Global Practice
...
\noindent \textbf{Maternal Health Analyst} \hfill \textsc{Mekelle, Ethiopia}\\
...
\noindent \textbf{PhD}: Transdisciplinary Solutions for Global Health (in progress: coursework completed, pending defense)\hfill \emph{January 2016-}\\
...
\noindent Dixon D, Deutsch K,... \textbf{Brew J},... Yang B. \emph{Modelling distributions of Aedes aegypti and Aedes albopictus using climate, host density and interspecies competition} \href{https://google.com} \\ DOI: xxx \hfill \emph{(Accepted)} \\
...
\noindent Chaccour C, Casellas A, Blanco-Di Matteo A,... \textbf{Brew J},... Fernandez-Alonso M. \emph{The effect of early treatment with ivermectin on viral load, symptoms and humoral response in patients with mild COVID-19: a pilot, double-blind, placebo-controlled, randomized clinical trial} \href{https://www.researchsquare.com/article/rs-116547/v1} (Pre-print) \\ Registration: https://clinicaltrials.gov/ct2/show/NCT04390022 \hfill \emph{(2020)} \\
