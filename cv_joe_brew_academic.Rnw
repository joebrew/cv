...
\fancyhead[C]{joebrew@gmail.com $\bullet$ Joe Brew $\bullet$ +34 666 66 80 86} % Custom header text
...
\scshape{\Sexpr{name}}\\
\end{Huge}
\Sexpr{email} \hfill  Carrer de Cienfuegos \\
\Sexpr{phone} \hfill  Entresol 2da \\
...
\item Research on the cost effectiveness and efficacy of malaria control interventions
\end{itemize}
...
\noindent Tran C, \textbf{Brew J}, Johnson N, Ryan K, Martin B, Cornett C, Caron B, Duncan R, Small P, Myers P, Morris J. \emph{Sustainability of School-located Influenza Vaccination Programs in Florida.} Vaccine. \\
(Accepted, publication pending) \hfill \emph{(2016)} \\
