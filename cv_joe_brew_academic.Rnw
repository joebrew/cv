...
\scshape{Joe Brew}\\
\end{Huge}
joebrew@gmail.com \hfill  Eerste Helmersstraat 275-3 \\
+31 655 936 200 \hfill 1054 DZ, Amsterdam (Netherlands)  \\
...
\noindent \emph{Expert:} R, SAS, Stata, SQL\\
...
\noindent \textbf{PhD}: Economics (in progress)\hfill \emph{January 2016-}\\
...
\noindent \textbf{Master of Arts}: Diplomacy\hfill \emph{September 2009-June 2010}\\
