...
phone <- "+36 666 66 80 86"
phone2 <- "+258 843 919 189"
@
\thispagestyle{plain}
\begin{center}
\begin{Huge}
\scshape{\Sexpr{name}}\\
\end{Huge}
\Sexpr{email} \hfill  Carrer de Cienfuegos, 10 / Entresol 2 \\
\Sexpr{phone} \hfill Barcelona, 08027 (Spain)  \\
\Sexpr{phone2} \hfill CISM, Vila da Manhiça, Bairro Cambeve, Rua 12 \\
...
\item Coursework in economics, epidemiology and policy
