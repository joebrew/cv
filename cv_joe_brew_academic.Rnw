...
\fancyhead[C]{joebrew@gmail.com $\bullet$ Joe Brew } % Custom header text
\begin{document}
\newgeometry{margin=2.5cm}
% \SweaveOpts{concordance=TRUE, echo=FALSE, eval=TRUE, results=hide}
...
\scshape{Joe Brew}\\
\end{Huge}
joebrew@gmail.com \hfill  Carrer de Cienfuegos, 10 / Entresol 2 \\
+36 666 66 80 86 \hfill Barcelona, 08027 (Spain)  \\
+258 843 919 189 \hfill CISM, Vila da Manhiça, Bairro Cambeve, Rua 12 \\
\href{https://orcid.org/0000-0002-4119-0117}{orcid.org/0000-0002-4119-0117} 
\hfill Distrito da Manhiça, CP 1929, Maputo (Mozambique) \\
\href{http://www.scopus.com/inward/authorDetails.url?authorID=56442459000&partnerID=MN8TOARS}{Scopus ID: 56442459000} \hfill
\href{http://economicsofmalaria.com}{www.economicsofmalaria.com} 
...
% 29 year-old American with a diverse educational background and significant international experience.  Thrives under pressure, takes intiative, likes to work.  Not an asshole.
% 
% \columnbreak
% 
...
% % 
% % 
% % \noindent -French, English, Spanish, Catalan\\
% % \noindent -R, SAS, SQL, Python, Latex \\
% % \noindent -Outbreak control and investigation\\
% % \noindent -GIS, data visualization\\
% % \noindent -Machine learning, BI, strategy
%  \end{multicols}
% 
% \vspace{-4mm}
...
% \noindent \textsc{(The following [and more] are available upon request)}\\
...
\noindent García-Basteiro A, Miranda R, \textbf{Brew J}, Sacoor C, Valencia S, Bulo H, Cobelens F, Macete E. \enph{Tuberculosis on the rise in southern Mozambique (1997–2012)}. \href{http://erj.ersjournals.com}{European Respiratory Journal} \\
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% \noindent \href{http://heb.sagepub.com/}{Health Education and Behavior} \hfill \emph{(2016)}
...
\noindent \textbf{Brew J}, Cirera L, Valls J, Sicuri E. \emph{Impact of a malaria elimination initiative on school outcomes in Southern Mozambique} \href{http://www.astmh.org/annual-meeting}{American Society of Tropical Medicine & Hygiene} \\
...
\noindent \textbf{Brew J}, Sicuri E. \emph{Silent pessimists: researchers' perceptions of malaria eradication and implications for health spending} \href{http://www.ectmih2017.be/}{European Conference of Tropical Medicine and Internaltional Health} \\
Anbwerp, Belgium \hfill \emph{(2017)}\\
...
\noindent \textbf{Brew J}, Cirera L, Vall J., Sicuri E. \emph{The educational impact of a malaria elimination campaign} \href{https://www.healtheconomics.org/page/BostonCongress2017}{Revolutions in the Economics of Health Systems: Congress of the International Health Economics Association} \\
...
%\item Use tools like Python (pandas, numpy, scikitlearn) and R
\end{itemize}
...
% \noindent \textbf{Volunteer} \hfill \textsc{Gainesville, FL, USA}\\
% \noindent \emph{Coalition of Immokalee Workers} \hfill \emph{2002}
% \vspace{-2mm}
% \begin{itemize}\itemsep0pt \parskip0pt \parsep0pt
% \item Advocated for the rights and dignity of migrant farmworkers
% \end{itemize}
