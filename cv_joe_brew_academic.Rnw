...
\noindent \emph{Control Flu Data Insights: Consent form return and vaccine hesitance}\\ Florida Department of Health, Alachua County (internal) \hfill \emph{2015}\\
...
\noindent \emph{Ciudad Quetzal: A Guatemalan City Grapples with Gang Terrorism} \\ Tico Times, Costa Rica \hfill \emph{2011}\\
...
\noindent \textbf{Data scientist} \hfill \textsc{Oakland, CA}\\
